...
md"""
In the previous session we saw how additive synthesis avoids aliasing by "sort of" working in the spectral domain. Now we see how actually working in the spectral domain can produce alias free waveshapes for any wavetable. 

- naive wavetable synthesis
- MIPS
- generating WTs from spectra
"""
