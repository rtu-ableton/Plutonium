...
md"""
### Introduction to anti-aliasing oscillator waveforms 2

- Integrating common signals
...
function impulses(N, period)
	map(x->(Int(x) % period == 0 ? 1.0 : 0.0), 1:N)
end

# ╔═╡ d1e06dc4-1cfb-48e0-96a0-dd51d02a4938
plot(impulses(100, 25))

# ╔═╡ 1939061d-6b96-4050-80aa-5a5805a9d431
plot(integrate(impulses(100, 25)))

# ╔═╡ 8f66fcdd-f78e-4b98-a06a-3029bcdb2b4c
# we can make a sqaure wave by adding two impulse trains & integrating
...
posNeg = impulses(N, period*2)[1:end-period+1] .- impulses(N, period*2)[period:end]
...
# ╔═╡ 0788bbc0-315c-4ca2-b096-52c0eabb040d
md"""
Whoops! Looks like we've stumbled upon one of the problems with integrators - th tiniest DC offset will accumulate forever.

What we would need is a "leaky integrator". One that leaks away any DC offset.
"""
